...
public class WeatherService {
    ...
    public WeatherService(VisualCrossingClient visualCrossingClient, RequestHistoryService historyService) {
    ...
    public WeatherResponse getCurrentWeatherByCity(String city) {
        historyService.saveCityRequest(city, "current");
    ...
    public WeatherResponse getCurrentWeatherByCoordinates(Double lat, Double lon) {
        historyService.saveCityRequest(lat + "," + lon, "current-coords");
    ...
    public ForecastResponse getForecast(String city, int days) {
        historyService.saveCityRequest(city, "forecast-" + days + "days");
    ...
    public HistoricalResponse getHistoricalData(String city, String startDate, String endDate) {
        historyService.saveCityRequest(city, "history");
