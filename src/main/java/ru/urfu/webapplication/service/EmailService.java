    ...
    public class EmailService {
        ...
        public void sendApiKeyEmail(String toEmail, String apiKey) {
            String subject = "Регистрация Weather Service";
            String text = String.format("""
                    Здравствуйте! Вы успешно зарегистрированы в Weather Service. Ваш API ключ: %s
                    ...
                    С уважением, Команда Weather Service.""", apiKey);
            try {
        ...
        public void sendPaymentSuccessEmail(String toEmail, String newApiKey, SubscriptionLevel level) {
        ...
        public void sendSubscriptionExpiredEmail(String toEmail, SubscriptionLevel oldLevel, String newApiKey) {
